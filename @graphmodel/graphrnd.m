function [G, varargout] = graphrnd2(obj, varargin)
...
%   [G, w, w_rem, alpha, sigma, tau, T] = GRAPHRND(obj, T)
...
%   - T: threshold
% For GGP bipartite:
%   [G, w1, w1_rem, w2, w2_rem, alpha1, sigma1, tau1, alpha2, sigma2, tau2, T1, T2] = GRAPHRND(obj, T)
...
%   [G, w, w_rem, alpha, sigma, tau, Fdist, gamma, T] = GRAPHRND(obj, T)
...
switch(obj.type)
    ...
    case 'GGP'
        ...
        switch(obj.typegraph)
            case 'undirected'
                [G, w, w_rem, alpha, sigma, tau, T] = GGPgraphrnd(obj.param.alpha, obj.param.sigma, obj.param.tau, varargin{:});
            ...
            case 'bipartite'
                [G, w1, w1_rem, w2, w2_rem, alpha1, sigma1, tau1, alpha2, sigma2, tau2, T1, T2] ...
                    = GGPbipgraphrnd(obj.param(1).alpha, obj.param(1).sigma, obj.param(1).tau, obj.param(2).alpha, obj.param(2).sigma, obj.param(2).tau, varargin{:});
                varargout = {w1, w1_rem, w2, w2_rem, alpha1, sigma1, tau1, alpha2, sigma2, tau2, T1, T2};
        end
    case 'CGGP'
        if nargin>2
            error('Only two possible inputs for objects of type CGGP')
        end
        switch(obj.typegraph)
            case 'undirected'
                [G, w, w_rem, alpha, sigma, tau, Fdist, gamma, T, w0, beta] = ...
                    ...
                    obj.param.observe_all, obj.param.infinite, varargin{:});
            ...
            case 'bipartite'
                [G, w1, w1_rem, w2, w2_rem, alpha1, sigma1, tau1, Fdist1, ...
                    ...
                    obj.param(2).gamma, [obj.param.observe_all], [obj.param.infinite], varargin{:});
                
                varargout = {w1, w1_rem, w2, w2_rem, alpha1, sigma1, tau1,...
                    Fdist1, gamma1, alpha2, sigma2, tau2, Fdist2, gamma2, T1, T2, w01, w02, beta1, beta2};
        end
    case 'BA'
